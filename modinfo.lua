...
local MappingOptions = {
	...
	{ description = Language_En and "Keyboard A"     or "键盘A键",         data = 97,     hover = ""},
	{ description = Language_En and "Keyboard B"     or "键盘B键",         data = 98,     hover = ""},
	{ description = Language_En and "Keyboard C"     or "键盘C键",         data = 99,     hover = ""},
	{ description = Language_En and "Keyboard D"     or "键盘D键",         data = 100,    hover = ""},
	{ description = Language_En and "Keyboard E"     or "键盘E键",         data = 101,    hover = ""},
	{ description = Language_En and "Keyboard F"     or "键盘F键",         data = 102,    hover = ""},
	{ description = Language_En and "Keyboard G"     or "键盘G键",         data = 103,    hover = ""},
	{ description = Language_En and "Keyboard H"     or "键盘H键",         data = 104,    hover = ""},
	{ description = Language_En and "Keyboard I"     or "键盘I键",         data = 105,    hover = ""},
	{ description = Language_En and "Keyboard J"     or "键盘J键",         data = 106,    hover = ""},
	{ description = Language_En and "Keyboard K"     or "键盘K键",         data = 107,    hover = ""},
	{ description = Language_En and "Keyboard L"     or "键盘L键",         data = 108,    hover = ""},
	{ description = Language_En and "Keyboard M"     or "键盘M键",         data = 109,    hover = ""},
	{ description = Language_En and "Keyboard N"     or "键盘N键",         data = 110,    hover = ""},
	{ description = Language_En and "Keyboard O"     or "键盘O键",         data = 111,    hover = ""},
	{ description = Language_En and "Keyboard P"     or "键盘P键",         data = 112,    hover = ""},
	{ description = Language_En and "Keyboard Q"     or "键盘Q键",         data = 113,    hover = ""},
	{ description = Language_En and "Keyboard R"     or "键盘R键",         data = 114,    hover = ""},
	{ description = Language_En and "Keyboard S"     or "键盘S键",         data = 115,    hover = ""},
	{ description = Language_En and "Keyboard T"     or "键盘T键",         data = 116,    hover = ""},
	{ description = Language_En and "Keyboard U"     or "键盘U键",         data = 117,    hover = ""},
	{ description = Language_En and "Keyboard V"     or "键盘V键",         data = 118,    hover = ""},
	{ description = Language_En and "Keyboard W"     or "键盘W键",         data = 119,    hover = ""},
	{ description = Language_En and "Keyboard X"     or "键盘X键",         data = 120,    hover = ""},
	{ description = Language_En and "Keyboard Y"     or "键盘Y键",         data = 121,    hover = ""},
	{ description = Language_En and "Keyboard Z"     or "键盘Z键",         data = 122,    hover = ""},
}
