...
CHANGE_INVENTORY_BAR_HINT_REMOVE_ACTION_TEXT = CHANGE_HIDE_INVENTORY_BAR_HINT == "part"
CHANGE_THEWORLD_ITEM_HINT_REMOVE_ACTION_TEXT = CHANGE_HIDE_THEWORLD_ITEM_HINT == "part"
...
-- modimport("scripts/change_frontend.lua")
modimport("scripts/change_functions.lua")
-- modimport("scripts/change_staff.lua")
modimport("scripts/change_mapscreen.lua")
modimport("scripts/change_optionsscreen.lua")
modimport("scripts/change_playercontroller.lua")
modimport("scripts/change_playerhud.lua")
modimport("scripts/change_inventorybar.lua")
-- modimport("scripts/change_craftingmenu.lua")
-- modimport("scripts/change_wheel.lua")
modimport("scripts/change_controls.lua")
-- modimport("scripts/change_reticule.lua")
-- modimport("scripts/change_placer.lua")
