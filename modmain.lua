...
CHANGE_IS_USE_DPAD_SELECT_CRAFTING_MENU_RT_CONFIRM  = CHANGE_IS_USE_DPAD_SELECT_CRAFTING_MENU == "scheme1"
CHANGE_IS_USE_DPAD_SELECT_SPELLWHEEL_ITEM = GetModConfigData("change_wheel")
CHANGE_IS_USE_DPAG_SELECT_SPELLWHEEL_ITEM_RT_CONFIRM = CHANGE_IS_USE_DPAD_SELECT_SPELLWHEEL_ITEM == "scheme1"
...
CHANGE_TUNING_CONTROLLER_RETICULE_RSTICK_CAST_SPEED  = GetModConfigData("reticule_cast_speed")  -- Default: 2
CHANGE_TUNING_CONTROLLER_RETICULE_RSTICK_BUILD_SPEED = GetModConfigData("reticule_build_speed")  -- Default: 0.5
